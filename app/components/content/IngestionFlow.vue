      ...
      <div class="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
        ...
        <div class="relative flex flex-col items-center select-none">
          ...
          <div class="w-full relative h-10 z-0">
            ...
            <div class="absolute left-1/2 top-[38px] -translate-x-1/2 w-2 h-2 rounded-full bg-rose-300 ring-2 ring-stone-50 dark:ring-stone-900" />
          </div>
          ...
          <div class="w-full max-w-xs rounded-2xl bg-stone-900 dark:bg-stone-800 border border-stone-700 shadow-xl z-10 overflow-hidden">
            <div class="px-4 py-3 flex items-center gap-3 border-b border-stone-700/60">
              <div class="w-8 h-8 rounded-xl bg-rose-500 flex items-center justify-center shrink-0 relative">
            ...
            <div class="px-4 py-3 space-y-2">
              <div v-for="doc in processingDocs" :key="doc.name" class="flex items-center gap-2">
                <div class="w-1.5 h-1.5 rounded-full shrink-0" :class="doc.done ? 'bg-green-400' : 'bg-rose-300 animate-pulse'" />
                <span class="text-[10px] text-stone-400 flex-1 truncate">{{ doc.name }}</span>
                <span class="text-[9px]" :class="doc.done ? 'text-green-400' : 'text-rose-300'">{{ doc.status }}</span>
              </div>
            </div>
            <div class="px-4 py-2 border-t border-stone-800 flex items-center justify-between">
              ...
              <span class="text-xs font-bold text-rose-300 font-mono">1.243</span>
            </div>
          </div>
          ...
          <div class="relative flex flex-col items-center z-0">
            ...
            <div class="w-2 h-2 rounded-full bg-rose-300 ring-2 ring-stone-50 dark:ring-stone-900" />
            <div class="w-px h-5 bg-stone-200 dark:bg-stone-700" />
          </div>
          ...
          <div class="w-full max-w-xs rounded-2xl bg-rose-950 border border-rose-800/60 shadow-lg shadow-rose-900/30 z-10 overflow-hidden">
            <div class="px-4 py-3 flex items-center gap-3">
              <div class="w-8 h-8 rounded-xl bg-rose-500/80 flex items-center justify-center shrink-0">
              ...
              <div class="flex-1 min-w-0">
                ...
                <p class="text-[10px] text-rose-300">Catálogo · Precios · Historial</p>
              </div>
            </div>
        ...
        <div>
          ...
          <p class="mt-1 text-lg font-semibold text-rose-500 dark:text-rose-300">
          ...
          <div class="mt-8 grid grid-cols-2 gap-4">
            ...
            >
              <div class="w-8 h-8 rounded-lg bg-stone-50 dark:bg-stone-700 border border-stone-200 dark:border-stone-600 flex items-center justify-center mb-3 group-hover:bg-rose-50 group-hover:border-rose-100 transition-colors">
                <UIcon :name="feat.icon" class="size-4 text-stone-400 group-hover:text-rose-500 transition-colors" />
              </div>
