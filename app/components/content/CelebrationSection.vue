    ...
    <div class="relative z-10 max-w-3xl px-4 sm:px-6 lg:px-8 mx-auto text-center">
      ...
      <div class="flex flex-wrap justify-center gap-4">
        <a
          ...
          class="inline-flex items-center gap-2 py-3 px-6 rounded-xl bg-rose-500 hover:bg-rose-400 text-white font-semibold text-base shadow-lg shadow-rose-900/40 hover:shadow-rose-800/50 transition-all"
        >
