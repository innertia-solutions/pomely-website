      ...
      <div class="flex items-center justify-between gap-x-4">
        ...
        <div class="flex items-center gap-2">
          ...
          <a
            ...
            class="py-1.5 px-3.5 inline-flex items-center gap-x-1.5 text-sm font-medium rounded-lg bg-rose-500 text-white hover:bg-rose-600 shadow-sm hover:shadow-none transition-all focus:outline-none"
          >
            Solicitar demo
          </a>
    ...
    <div v-if="menuOpen" class="md:hidden border-t border-stone-200 dark:border-stone-700 bg-white dark:bg-stone-900">
      <div class="px-4 py-3 flex flex-col gap-1">
        ...
        <div class="mt-2 pt-2 border-t border-stone-100 dark:border-stone-800">
          <a
            href="mailto:hola@pomely.cl"
            class="w-full py-2.5 px-3 flex justify-center text-sm font-medium rounded-lg bg-rose-500 text-white hover:bg-rose-600 transition-colors"
          >
            Solicitar demo
          </a>
        </div>
